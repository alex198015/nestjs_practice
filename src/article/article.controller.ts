...
import { Body, Controller, Post, UseGuards, Get, Param, Delete, Put, UsePipes, Query } from '@nestjs/common';
...
export class ArticleController {
    ...
    @Get(':slug')
    async getSingleArticle(@Param('slug') slug: string): Promise<ArticleResponceInterface> {
    ...
    @Post(':slug/favorite')
    @UseGuards(AuthGuard)
    async addArticleToFavorites(@User('id') currentUserId: number, @Param('slug') slug: string): Promise<ArticleResponceInterface> {
    ...
    @UseGuards(AuthGuard)
    async deleteArticleFromFavorites(@User('id') currentUserId: number, @Param('slug') slug: string): Promise<ArticleResponceInterface> {
